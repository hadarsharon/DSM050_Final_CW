...
#### April 2026 session, MSc Data Science programme
...
![Reported global camel stock, 1961–2024, highlighting the acceleration in growth after 2000](figures/fig01_global_stock.png)
...
![Ten-year rolling annualised growth in global camel stock](figures/fig02_rolling_growth.png)
...
![Contribution of successive periods to global camel-stock growth](figures/fig03_period_growth.png)
...
![Continental shares of reported FAOSTAT World camel stock, 1961–2024](figures/fig04_continent_share.png)
...
![Largest reported national camel herds in 2024 and their shares of World stock.](figures/fig05_country_concentration.png)
...
![Geographic distribution of change in reported camel stock, 2000–2024, with the largest contributors to the global net increase highlighted](figures/fig06_post2000_contributors.png)
...
![Changes in rank among leading present-day national camel herds, 1961–2024.](figures/fig07_rank_changes.png)
...
![Indexed long-run trajectories of leading present-day national camel herds relative to their 1961 stock levels.](figures/fig08_indexed_trajectories.png)
...
![Relationship between total national camel herd size and recorded camel milk production in 2024, shown on logarithmic scales.](figures/fig09_stock_vs_milk.png)

\FloatBarrier

![Relationship between total national camel herd size and recorded camel meat production in 2024, shown on logarithmic scales.](figures/fig10_stock_vs_meat.png)
...
![Recorded milk and meat production relative to values fitted from herd size alone for major national camel herds in 2024.](figures/fig11_output_residuals.png)
...
![National camel production profiles in 2024, comparing recorded milk and meat production intensity per 1,000 camels; bubble area represents total herd size.](figures/fig12_production_profiles.png)
...
![Camel milk production structure in 2024: number of milk animals, recorded yield and total production.](figures/fig13_milk_decomposition.png)
...
![Camel meat production structure in 2024: animals slaughtered, recorded carcass weight and total production.](figures/fig14_meat_decomposition.png)
...
![Stock-weighted FAOSTAT provenance categories for reported camel stocks at selected benchmark years, 1961–2024.](figures/fig15_flag_share.png)
...
![Provenance flags of the ten largest reported national camel herds in 2024; bar length represents each country's share of World stock.](figures/fig16_2024_flag_fingerprint.png)
...
![Annual FAOSTAT provenance flags, 2000–2024, for the eight largest reported national camel herds in 2024.](figures/fig17_flag_history.png)
